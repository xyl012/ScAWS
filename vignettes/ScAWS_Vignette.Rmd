...
My background:
```{r timeline, out.width = '150%', out.height='150%', echo=F, warning=F, message=FALSE, results='hide'}
require(vistime)
data=read.csv(text="event,start,end
                       B.S. University of Hawaii,2008-01-01,2012-01-01
                       M.S. University of Hawaii,2012-01-02,2015-01-01
