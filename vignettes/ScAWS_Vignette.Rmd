...
#seurat_object_list=seurat_process_list(seurat_object_list)
#integrated_seurat_object=integrate_seurat_object_list(seurat_object_list, npcs=30, dims=30)
```

```{r}
#p1=DimPlot(integrated_seurat_object, reduction = "umap", group.by = "stim")
